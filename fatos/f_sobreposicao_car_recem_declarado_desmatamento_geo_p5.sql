...
for counter in 1501..((select count(*) from processado.f_detalhe_imovel_desmatamento_pre_declaracao me) /100) +1 loop
...
analise_espacial_2 as (
	select 
      	...
      	st_intersection(ST_MakeValid(ig.geom), ST_MakeValid(an1.geo_area_agregada)) as geom_intersection           
