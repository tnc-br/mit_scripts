...
-- drop table if exists processado.f_detalhe_imovel_zona_compra_frigorifico cascade;
--
-- CREATE TABLE processado.f_detalhe_imovel_zona_compra_frigorifico (
-- 	id_zc int4 NULL,
-- 	id_imovel int8 NULL,
...
-- 	area_over_frigorifico_ha float8 NULL,
-- 	area_calc_ir_ha float8 NULL,
-- 	perc_over_frigorifico float8 NULL
-- );
...
truncate table processado.f_detalhe_imovel_zona_compra_frigorifico;
